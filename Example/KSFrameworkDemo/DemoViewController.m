...
- (void)setupMenuBarButtonItems {
    ...
    if(self.slideController.menuState == KSSlideControllerStateClosed &&
...
- (void)leftSideMenuButtonPressed:(id)sender {
    [self.slideController toggleLeftSideMenuCompletion:^{
        [self setupMenuBarButtonItems];
    }];
}

- (void)rightSideMenuButtonPressed:(id)sender {
    [self.slideController toggleRightSideMenuCompletion:^{
        [self setupMenuBarButtonItems];
    }];
}
